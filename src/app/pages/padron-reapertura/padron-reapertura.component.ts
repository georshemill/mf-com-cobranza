...
@Component({
  selector: 'app-padron-reapertura',
  imports: [ParametrosModule],
  templateUrl: './padron-reapertura.component.html',
  styleUrl: './padron-reapertura.component.scss',
  providers: [CobranzaService]
})
export class PadronReaperturaServicioComponent implements OnInit {
