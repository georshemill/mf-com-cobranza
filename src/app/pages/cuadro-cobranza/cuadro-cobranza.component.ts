...
@Component({
  selector: 'app-cuadro-cobranza',
  imports: [ParametrosModule],
  templateUrl: './cuadro-cobranza.component.html',
  styleUrl: './cuadro-cobranza.component.scss',
    providers: [CobranzaService]
})
export class CuadroCobranzaComponent {
  ...
  idEmpresaTk = GlobalSession.idEmpresa;
    ...
    searchCierre(){
      ...
      this.urlView=`${this.urlImpresion}/cobranza/altoconPago.php?idempresa=1&idsede=${this.idSedeTk}&idsucursal=${this._cierreModel.idSucursal}&idciclo=${this._cierreModel.idCiclo}&fechaini=${this._cierreModel.fecDesde}&fechafin=${this._cierreModel.fecHasta}` ;
