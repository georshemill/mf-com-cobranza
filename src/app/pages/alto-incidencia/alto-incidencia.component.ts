...
@Component({
  selector: 'app-alto-incidencia',
  imports: [ParametrosModule],
  templateUrl: './alto-incidencia.component.html',
  styleUrl: './alto-incidencia.component.scss',
  providers: [CobranzaService]
})
export class AltoIncidenciaComponent {
    ...
    searchCierre(){
      ...
      this.urlView=`${this.urlImpresion}/cobranza/altoconindicencia.php?idempresa=1&idsede=${this.idSedeTk}&idsucursal=${this._cierreModel.idSucursal}&idciclo=${this._cierreModel.idCiclo}&fechaini=${this._cierreModel.fecDesde}&fechafin=${this._cierreModel.fecHasta}` ;
