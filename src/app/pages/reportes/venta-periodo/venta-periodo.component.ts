...
@Component({
  selector: 'app-venta-periodo',
  imports: [ParametrosModule],
  templateUrl: './venta-periodo.component.html',
  styleUrl: './venta-periodo.component.scss',
  providers: [CobranzaService]
})
export class VentaPeriodoComponent {
    ...
    displayPDF:boolean=false
      ...
      searchResumen(){
       ...
       /// showGlobalLoader()
        ...
        this.urlView=`${this.urlImpresion}/cobranza/CobranzaVentaXPeriodo.php?idempresa=1&idsede=${this.idSedeTk}&idsucursal=${this._facMensualModel.idSucursal}&idciclo=${this._facMensualModel.idCiclo}&anio=${this._facMensualModel.anio}&mes=${this._facMensualModel.mes}` ;
